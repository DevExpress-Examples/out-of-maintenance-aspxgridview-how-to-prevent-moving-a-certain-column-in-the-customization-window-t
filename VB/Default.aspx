...
<body>
	<form id="form1" runat="server">
	  ...
	  <br />
	 <dx:ASPxGridView ID="GridView" ClientInstanceName="grid" DataSourceID="AccessDataSource1" OnAfterPerformCallback="GridView_AfterPerformCallback" KeyFieldName="ProductID" runat="server" Width="100%">
